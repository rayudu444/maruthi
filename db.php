<?php
include_once 'admin/includes/database.class.php';
mysql_connect("localhost","maruthic_cabs","maruthicabs");
mysql_select_db("maruthic_cabs");

 define ( "DB_HOST", "localhost" );
	define ( "DB_USER", "maruthic_cabs" );
	define ( "DB_PASS", "maruthicabs" );
	define ( "DB_NAME", "maruthic_cabs" );
...
function delete_row($table,$cond){
	...
	//echo "delete  from $table  $cond";exit();
