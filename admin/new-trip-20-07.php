       ...
       <div class="offer-right-div">
		...
		if(isset($_POST['submit'])){
			...
			if($mobile!='' && $start_date!='' && $start_time!='' && $email!='' && $username!='' && $start_location!=''){
				...
				$sql=mysql_query("INSERT INTO `trip_reg`(`id`, `mobile`, `name`, `email`, `start_date`, `start_time`, `start_location`, `cartype`, `end_location`, `status`,`service_provider`,`mobile1`,`mobile2`) VALUES ('id','$mobile','$username','$email','$start_date','$start_time','$start_location','$cartype','$end_location','0','$service_provider','$mobile1','$mobile2')");
            ...
            <div class="table2" style="width:80%;margin:0px auto;">
              ...
              <form class="upload-form" method="post" action="">
                ...
                <div class="upload-pro">
                  ...
                  <input type="text" placeholder="Start Date" ID="txtFrom1" name="start_date"/>
