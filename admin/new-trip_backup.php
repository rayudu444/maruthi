       ...
       <div class="offer-right-div">
		...
		if(isset($_POST['submit'])){
			...
			if($mobile!='' && $start_date!='' && $start_time!='' && $email!='' && $username!='' && $start_location!=''){
				...
				$sql=mysql_query("INSERT INTO `trip_reg`(`id`, `mobile`, `name`, `email`, `start_date`, `start_time`, `start_location`, `cartype`, `end_location`, `status`,`service_provider`) VALUES ('id','$mobile','$username','$email','$start_date','$start_time','$start_location','$cartype','$end_location','0','$service_provider')");
