                ...
                <div class="upload-pro">
                  <label>Package</label>
	                  ...
	                  <select name="package">
	                    ...
	                    <option value="Standard Rate" <?php if($package=="Standard Rate"){ echo "selected='selected'"; } ?>>Standard Package</option>
	
	                    <option value="Airport Rate" <?php if($package=="Airport Rate"){ echo "selected='selected'"; } ?>>Airport Package</option>
