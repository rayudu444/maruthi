        ...
        <div class="content-total-box">
            ...
            <div class="table2" >
					...
					<tr>
                        ...
                        <th class="edit-center">Free waiting  Minutes</th>
                        <th class="edit-center">Ride time charges</th>
                        <th class="edit-center">Free Ride Minutes</th>
			...
			<tr>
                ...
                <td class="edit-center"><?php echo $re['free_waiting_mins']; ?></td>
                <td class="edit-center"><?php echo $re['ride_charges']; ?></td>
                <td class="edit-center"><?php echo $re['free_ride_mins']; ?></td>
