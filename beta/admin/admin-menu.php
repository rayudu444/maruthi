           ...
           <ul>
            ...
            <li> <i class="fa fa-keyboard-o icon"></i><a><span>Trip History</span></a>
             ...
             <li> <i class="fa fa-keyboard-o icon"></i><a><span>Drivers</span></a>
              <ul <?php if($link=="add-drivers.php" || $link=="view-drivers.php"){ echo 'style="display:block;"'; } ?>>
                <li <?php if($link=="add-drivers.php"){ echo 'class="text-bold"'; } ?>><i class="fa fa-plus icon1"></i><a href="add-drivers.php">Add Drivers</a></li>
                <li <?php if($link=="view-drivers.php"){ echo 'class="text-bold"'; } ?>><i class="fa fa-eye icon1"></i><a href="view-drivers.php">View Drivers</a></li>
              </ul>
            </li>
            <li> <i class="fa fa-keyboard-o icon"></i><a><span>Cabs</span></a>
              <ul <?php if($link=="add-cabs.php" || $link=="view-cabs.php" || $link=="assign-cabs.php"){ echo 'style="display:block;"'; } ?>>
                <li <?php if($link=="add-cabs.php"){ echo 'class="text-bold"'; } ?>><i class="fa fa-plus icon1"></i><a href="add-cabs.php">Add Cabs</a></li>
				<li <?php if($link=="view-cabs.php"){ echo 'class="text-bold"'; } ?>><i class="fa fa-eye icon1"></i><a href="view-cabs.php">View Cabs</a></li>
                <li <?php if($link=="assign-cabs.php"){ echo 'class="text-bold"'; } ?>><i class="fa fa-sign-in icon1"></i><a href="assign-cabs.php">Assign Cabs</a></li>
              </ul>
            </li>
			...
			<li> <i class="fa fa-keyboard-o icon"></i><a><span>Fare Chart</span></a>
               <ul <?php if($link=="fare-chart.php"){ echo 'style="display:block;"'; } ?>>
                <li <?php if($link=="fare-chart.php"){ echo 'class="text-bold"'; } ?>><i class="fa fa-plus icon1"></i><a href="fare-chart.php">Fare Chart</a></li>
              </ul>
             </li>
