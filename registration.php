...
jQuery( document ).ready(function( $ ) {
  ...
  if(isset($_POST['submit'])){
	  ...
	  $sql=mysql_query("INSERT INTO `registration`(`id`, `crdate`, `name`, `email`, `mobile`, `password`, `otp`,`status`, `push_id`) VALUES ('id','$crdate','$username','$email','$mobile','$password','$otp','0','')");
	  ...
	  if($sql){ //echo "<div class='admin_success'>Successfully Registered.</div>";
		...
		//echo $url;
		$ret = file($url); 
		$sql1=mysql_query("select * from registration where mobile='$mobile'");
